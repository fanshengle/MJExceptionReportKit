...
/// 地图View的手势Delegate
@property (nonatomic, weak, nullable) id<BMKMapGestureDelegate> gestureDelegate;

/// 当前地图类型，可设定为标准地图、卫星地图
@property (nonatomic, assign) BMKMapType mapType;

/// 地图底图语言类型 （暂不支持多地图）since 6.4.0
...
@property(nonatomic, assign) BOOL gestureZoomAnimationEnabled;
...
/// V6.5.2版本新增
/// 设置地图是否使用Metal绘制，请在创建BMKMapView前设置有效
...
@interface BMKMapView (CustomMapAPI)
